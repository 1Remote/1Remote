...
namespace PRM.View.ProtocolHosts
{
    public partial class FileTransmitHost : HostBase
    {
        ...
        public FileTransmitHost(PrmContext context, ProtocolServerBase protocolServer) : base(context, protocolServer, false)
        {
            ...
            {
                _vmRemote = new ViewModel.VmFileTransmitHost(context, protocolServerSftp);
            }
            else if (protocolServer is ProtocolServerFTP protocolServerFtp)
            {
                _vmRemote = new ViewModel.VmFileTransmitHost(context, protocolServerFtp);
            }
            else
            ...
            {
                if (args.PropertyName == nameof(ViewModel.VmFileTransmitHost.SelectedRemoteItem))
                {
